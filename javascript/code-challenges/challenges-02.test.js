...
const mapTwoToThe = (arr) => {
  ...
  let newArr = [];
  arr.map((e) => {
    return newArr.push(Math.pow(2, e));
  });
  return newArr;
};
...
const charCode = (arr) => {
  ...
  let newArr = [];
  arr.map((e) => {
    return newArr.push(e.charCodeAt());
  });
  return newArr;
};
...
const evenOdd = (arr) => {
  ...
  arr.map((e) => {
    if (e % 2 === 0) {
      return newArr.push("even");
    } else if (e % 2 === 1) {
      return newArr.push("odd");
    } else return newArr.push("N/A");
  });
  return newArr;
};
...
const extractAbilities = (arr) => {
  ...
  let newArr = [];
  arr.map((e) => {
    return newArr.push(e.ability.name);
  });
  return newArr;
};
...
const extractStats = (arr) => {
  ...
  let newArr = [];
  arr.map((element) => {
    return newArr.push({ name: element.stat.name, total: element.effort + element.baseStat });
  });
  return newArr;
};
